...
const team = [
  ...
  },
  {
    ...
    bio: "Bridges editorial work and audience needs so stories reach the people who need them most.",
  },
  {
    name: "Michael Vann",
    role: "Senior Reporter",
    image: "/images/team/chef-michael.jpg",
    bio: "Covers features and field reporting with a strong eye for local detail and human context.",
  },
  {
    name: "Emma Sok",
    ...
    <main>
      ...
      <section id="team" class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div class="inline-flex items-center gap-2 text-sm font-medium text-slate-500 dark:text-slate-400">
            <Handshake class="size-4 text-red-600" />
            Assignee: @longheng369
          </div>
        </div>
