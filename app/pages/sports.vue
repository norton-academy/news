...
import { useSportsFeed, SPORTS_SUB_TOPICS } from '~/composables/useSportsFeed'
...
useSeoMeta({
  title: 'Sports',
  description: 'Latest Cambodia sports news covering football, boxing, athletics, basketball, and motorsport.',
})
