...
import { useEducationFeed, EDUCATION_SUB_TOPICS } from '~/composables/useEducationFeed'
...
useSeoMeta({
  title: 'Education',
  description: 'Latest Cambodia education news covering K-12, higher education, edtech, scholarships, teachers, and policy.',
})
    ...
    <div class=" mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 xl:grid-cols-4 gap-8 items-start">
        ...
        <NewSidebar
          ...
          :sub-topics="EDUCATION_SUB_TOPICS"
