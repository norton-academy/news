...
<template>
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white font-sans antialiased">
    <!-- Header / Navigation (same as homepage, Technology active) -->
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div class="relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 shadow-xl group">
          ...
          <div class="absolute bottom-0 left-0 right-0 z-20 p-6 md:p-10 bg-gradient-to-t from-black/90 to-transparent">
            <div class="flex items-center gap-2 text-sm text-red-300 font-semibold mb-3">
              <span class="bg-red-600 text-white px-2 py-0.5 rounded text-xs">TECH INNOVATION</span>
              <span>2 days ago</span>
            </div>
            <h1 class="text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-3 drop-shadow-lg">
              Cambodia Launches First 5G Smart City Project in Siem Reap
            </h1>
            <p class="text-gray-200 text-sm md:text-base max-w-2xl line-clamp-2">
              Partnership with Huawei brings autonomous traffic, smart lighting, and IoT infrastructure to tourist hub.
            </p>
          </div>
        </div>
      </section>

      <!-- Section Header with Tech Filter Tabs -->
      <div class="flex flex-wrap items-center justify-between gap-4 mb-8 pb-2 border-b border-gray-200">
        ...
        <div class="text-sm text-gray-500 flex items-center gap-1">
          <Cpu class="w-4 h-4" /> Cutting-edge
        </div>
      </div>

      <!-- Featured Tech Articles Grid -->
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
        ...
        <div class="lg:col-span-2 group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100">
          <div class="relative overflow-hidden h-64 md:h-80">
            <img 
              src="https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=800&h=500&fit=crop" 
              alt="AI Robotics"
          ...
          <div class="p-6">
            <div class="flex items-center gap-3 text-xs text-gray-500 mb-2">
              ...
              <span class="flex items-center gap-1"><Database class="w-3 h-3" /> AI & Robotics</span>
            </div>
            <NuxtLink to="/article/3">
              <h3 class="text-2xl md:text-3xl font-bold text-gray-800 mb-3 group-hover:text-red-600 transition-colors duration-200">
                Cambodian AI Startup Raises $12M Series A for Agriculture Solutions
              </h3>
            </NuxtLink>
            <p class="text-gray-600 text-base mb-4 line-clamp-3">
              'AgriMind' uses computer vision to detect crop diseases, aiming to increase rice yields by 30% for smallholder farmers.
            </p>
            <div class="flex items-center gap-3">
              <img src="https://randomuser.me/api/portraits/women/44.jpg" class="w-8 h-8 rounded-full" alt="author" />
              <span class="text-sm text-gray-600">Sreynoch Lim • Tech Reporter</span>
            </div>
          </div>
        </div>

        <!-- Side list of latest tech news -->
        <div class="space-y-4">
          <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-100 transition-all hover:shadow-md">
            <div class="flex gap-4">
              <div class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=150&h=150&fit=crop" class="w-full h-full object-cover" alt="news" />
              </div>
              <div>
                <span class="text-xs font-semibold text-red-600">Cybersecurity</span>
                <NuxtLink to="/article/3">
                  <h4 class="font-bold text-gray-800 line-clamp-2 hover:text-red-600 cursor-pointer transition">New Data Protection Law Takes Effect: What Businesses Must Know</h4>
                </NuxtLink>
          ...
          <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-100 transition-all hover:shadow-md">
            <div class="flex gap-4">
              <div class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=150&h=150&fit=crop" class="w-full h-full object-cover" alt="news" />
              </div>
              <div>
                <span class="text-xs font-semibold text-red-600">Gadgets</span>
                <NuxtLink to="/article/3">
                  <h4 class="font-bold text-gray-800 line-clamp-2 hover:text-red-600 cursor-pointer transition">Smartphone Market in Cambodia Grows 18% in Q1 2025</h4>
                </NuxtLink>
                <div class="flex items-center gap-2 text-xs text-gray-500 mt-1">
          ...
          <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-100 transition-all hover:shadow-md">
            <div class="flex gap-4">
              <div class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=150&h=150&fit=crop" class="w-full h-full object-cover" alt="news" />
              </div>
              <div>
                <span class="text-xs font-semibold text-red-600">Telecom</span>
                <NuxtLink to="/article/3">
                  <h4 class="font-bold text-gray-800 line-clamp-2 hover:text-red-600 cursor-pointer transition">Smart Axiata Launches 5G SA Network in Phnom Penh</h4>
                </NuxtLink>
                <div class="flex items-center gap-2 text-xs text-gray-500 mt-1">
      ...
      <!-- Regular Technology Articles Grid (filtered by active tab) -->
      <div class="mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div 
            v-for="(article, idx) in filteredTechArticles" 
            :key="article.id"
      ...
      <!-- Tech Innovation Spotlight Section -->
      <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-12">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
          <h3 class="text-xl font-bold text-gray-900 flex items-center gap-2">
            <Rocket class="w-5 h-5 text-red-600" /> Innovation Spotlight
          </h3>
          <span class="text-xs text-gray-500">Sponsored by Khmer Digital Hub</span>
        </div>
        <div class="grid md:grid-cols-3 gap-6">
          <div class="text-center group cursor-pointer">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 transition-all group-hover:shadow-md">
              <div class="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <Cloud class="w-6 h-6 text-red-600" />
              </div>
              <h4 class="font-bold text-gray-800">Cloud Adoption</h4>
              <p class="text-xs text-gray-500 mt-1">Enterprise shift to hybrid cloud accelerates</p>
            </div>
          </div>
          <div class="text-center group cursor-pointer">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 transition-all group-hover:shadow-md">
              ...
              <h4 class="font-bold text-gray-800">Mobile Finance</h4>
              <p class="text-xs text-gray-500 mt-1">Bakong app reaches 10M users</p>
            </div>
          </div>
          <div class="text-center group cursor-pointer">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 transition-all group-hover:shadow-md">
              <div class="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <Wifi class="w-6 h-6 text-red-600" />
              </div>
              <h4 class="font-bold text-gray-800">Rural Connectivity</h4>
              <p class="text-xs text-gray-500 mt-1">Universal service fund expands 4G coverage</p>
            </div>
          </div>
        </div>
      </div>

      <!-- Interview / Q&A with Tech Leader -->
        ...
        <div class="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
          <div>
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-red-400 font-semibold text-sm uppercase tracking-wider">Q&A</span>
            </div>
            <h3 class="text-2xl md:text-3xl font-bold mb-2">"We're Building Cambodia's Digital Backbone"</h3>
            <p class="text-gray-300 max-w-2xl">Interview with Dr. Samnang Eang, Director of the National ICT Development Authority.</p>
          </div>
      ...
      <!-- More Tech News Load More Button -->
...
import { 
  ...
  Facebook, Twitter, Instagram, Clock, Cpu, Database, Rocket, Cloud, 
  Smartphone, Wifi, Users
...
// Navigation items (Technology active)
const navItems = ref([
...
// Technology sub-tabs
const techTabs = ['All', 'AI', 'Cybersecurity', 'Gadgets', 'Software', 'Telecom']
const activeTab = ref('All')

// Technology articles data (Cambodia focused)
const techArticles = ref([
  {
    id: 1,
    title: "AI-Powered Khmer Language Translator Achieves 95% Accuracy",
    excerpt: "New model bridges digital divide, enabling better access to e-government services.",
  ...
  {
    id: 2,
    title: "Major Bank Suffers Data Breach: 50,000 Customer Records Exposed",
    excerpt: "Regulators investigate as cybersecurity experts urge stronger protections.",
  ...
  {
    id: 3,
    title: "Xiaomi Launches Affordable 5G Smartphone for Cambodian Market",
    excerpt: "Sub-$200 device aims to accelerate 5G adoption among young consumers.",
    image: "https://images.unsplash.com/photo-1592899677977-9e10ca5889f8?w=400&h=250&fit=crop",
    subcategory: "Gadgets",
    date: "May 26, 2025",
    views: "2.8k"
  },
  {
    id: 4,
    title: "Open Source E-Platform for Schools Gains Government Backing",
    excerpt: "Ministry of Education endorses 'LearnKhmer' software for nationwide rollout.",
  ...
  {
    id: 5,
    title: "Metfone Invests $50M in 5G Infrastructure Expansion",
    excerpt: "Coverage to reach 80% of provincial capitals by end of 2025.",
  ...
  {
    id: 6,
    title: "Phnom Penh's First AI Incubator Opens Applications",
    excerpt: "Program offers seed funding and mentorship for local AI startups.",
...
const filteredTechArticles = computed(() => {
  if (activeTab.value === 'All') return techArticles.value
  return techArticles.value.filter(article => article.subcategory === activeTab.value)
})
