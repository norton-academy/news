...
import { useHealthFeed, HEALTH_SUB_TOPICS } from '~/composables/useHealthFeed'
...
useSeoMeta({
  title: 'Health',
  description: 'Latest Cambodia health news covering hospitals, public health, pharmacy, vaccines, safety, and wellness.',
})
