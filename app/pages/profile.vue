...
const handleUpdateProfile = async () => {
  ...
  try {
    ...
    toast.success('Profile updated', 'Your profile information was updated successfully.')
  } catch (error: any) {
...
const handleUpdatePassword = async () => {
  ...
  try {
    ...
    if (error.errors) {
      ...
      passwordErrors.password_confirmation = error.errors.password_confirmation?.[0] || ''
    }
  } finally {
      ...
      <div class="grid gap-6 lg:grid-cols-3">
        ...
        <AppCard class="lg:col-span-1">
          <div class="flex flex-col items-center text-center">
            <div class="flex h-24 w-24 items-center justify-center rounded-full bg-slate-900 text-3xl font-bold text-white">
