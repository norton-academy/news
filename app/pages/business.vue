...
<template>
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white font-sans antialiased">
    <!-- Header / Navigation (same as homepage, Business active) -->
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div class="relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 shadow-xl group">
          ...
          <div class="absolute bottom-0 left-0 right-0 z-20 p-6 md:p-10 bg-gradient-to-t from-black/90 to-transparent">
            <div class="flex items-center gap-2 text-sm text-red-300 font-semibold mb-3">
              <span class="bg-red-600 text-white px-2 py-0.5 rounded text-xs">MARKET INSIGHT</span>
              <span>Updated 1 hour ago</span>
            </div>
            <h1 class="text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-3 drop-shadow-lg">
              Cambodia's Stock Exchange Sees Record Trading Volume in Q2
            </h1>
            <p class="text-gray-200 text-sm md:text-base max-w-2xl line-clamp-2">
              Investor confidence surges as new listings and foreign participation drive CSX to all-time highs.
            </p>
          </div>
        </div>
      </section>

      <!-- Section Header with Business Filter Tabs -->
      <div class="flex flex-wrap items-center justify-between gap-4 mb-8 pb-2 border-b border-gray-200">
        ...
        <div class="text-sm text-gray-500 flex items-center gap-1">
          <TrendingUp class="w-4 h-4" /> Markets live
        </div>
      </div>

      <!-- Featured Business Articles Grid -->
        ...
        <div class="lg:col-span-2 group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100">
          <div class="relative overflow-hidden h-64 md:h-80">
            ...
            <div class="absolute top-3 left-3">
              <span class="px-2 py-1 bg-red-600 text-white text-xs font-semibold rounded-md shadow-md">Exclusive</span>
            </div>
          </div>
          <div class="p-6">
            <div class="flex items-center gap-3 text-xs text-gray-500 mb-2">
              <span class="flex items-center gap-1"><Calendar class="w-3 h-3" /> May 28, 2025</span>
              <span class="flex items-center gap-1"><BarChart3 class="w-3 h-3" /> Financial analysis</span>
            </div>
            <NuxtLink to="/article/2">
              <h3 class="text-2xl md:text-3xl font-bold text-gray-800 mb-3 group-hover:text-red-600 transition-colors duration-200">
                Banking Sector Consolidation: Three Mergers Approved by NBC
              </h3>
            </NuxtLink>
            <p class="text-gray-600 text-base mb-4 line-clamp-3">
              The National Bank of Cambodia greenlights major acquisitions, aiming to strengthen the financial system and increase competitiveness.
            </p>
            <div class="flex items-center gap-3">
              <img src="https://randomuser.me/api/portraits/men/45.jpg" class="w-8 h-8 rounded-full" alt="author" />
              <span class="text-sm text-gray-600">Rithy Samnang • Business Editor</span>
            </div>
          </div>
        </div>

        <!-- Side list of latest business news -->
        <div class="space-y-4">
          <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-100 transition-all hover:shadow-md">
            <div class="flex gap-4">
              <div class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=150&h=150&fit=crop" class="w-full h-full object-cover" alt="news" />
              </div>
              <div>
                <span class="text-xs font-semibold text-red-600">Real Estate</span>
                <NuxtLink to="/article/2">
                  <h4 class="font-bold text-gray-800 line-clamp-2 hover:text-red-600 cursor-pointer transition">Phnom Penh Property Market Rebounds with 15% Price Growth</h4>
                </NuxtLink>
          ...
          <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-100 transition-all hover:shadow-md">
            <div class="flex gap-4">
              <div class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=150&h=150&fit=crop" class="w-full h-full object-cover" alt="news" />
              </div>
              <div>
                <span class="text-xs font-semibold text-red-600">Tourism</span>
                <NuxtLink to="/article/2">
                  <h4 class="font-bold text-gray-800 line-clamp-2 hover:text-red-600 cursor-pointer transition">International Arrivals Surpass Pre-Pandemic Levels</h4>
                </NuxtLink>
                <div class="flex items-center gap-2 text-xs text-gray-500 mt-1">
          ...
          <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-100 transition-all hover:shadow-md">
            <div class="flex gap-4">
              <div class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                <img src="https://images.unsplash.com/photo-1556742049-0cfed2f6c45d?w=150&h=150&fit=crop" class="w-full h-full object-cover" alt="news" />
              </div>
              <div>
                <span class="text-xs font-semibold text-red-600">E-commerce</span>
                <NuxtLink to="/article/2">
                  <h4 class="font-bold text-gray-800 line-clamp-2 hover:text-red-600 cursor-pointer transition">New Digital Payment Law to Boost Cashless Economy</h4>
                </NuxtLink>
                <div class="flex items-center gap-2 text-xs text-gray-500 mt-1">
      ...
      <!-- Regular Business Articles Grid (filtered by active tab) -->
      <div class="mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div 
            v-for="(article, idx) in filteredBusinessArticles" 
            :key="article.id"
      ...
      <!-- Business Data / Market Ticker Section (Visual) -->
      <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-12">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
          <h3 class="text-xl font-bold text-gray-900 flex items-center gap-2">
            <LineChart class="w-5 h-5 text-red-600" /> Market Snapshot
          </h3>
          <span class="text-xs text-gray-500">Last updated: May 28, 2025, 15:30 ICT</span>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div class="p-4 bg-gray-50 rounded-xl text-center hover:shadow-md transition">
            <p class="text-sm text-gray-500">CSX Index</p>
            <p class="text-2xl font-bold text-gray-800">678.42</p>
            <p class="text-green-600 text-sm flex items-center justify-center gap-1"><TrendingUp class="w-3 h-3" /> +2.3%</p>
          </div>
          <div class="p-4 bg-gray-50 rounded-xl text-center hover:shadow-md transition">
            <p class="text-sm text-gray-500">USD/KHR</p>
            <p class="text-2xl font-bold text-gray-800">4,065</p>
            <p class="text-gray-500 text-sm">+0.05%</p>
          </div>
          <div class="p-4 bg-gray-50 rounded-xl text-center hover:shadow-md transition">
            <p class="text-sm text-gray-500">GDP Growth (2025)</p>
            <p class="text-2xl font-bold text-gray-800">6.2%</p>
            <p class="text-green-600 text-sm">forecast</p>
          </div>
          <div class="p-4 bg-gray-50 rounded-xl text-center hover:shadow-md transition">
            <p class="text-sm text-gray-500">Inflation (YoY)</p>
            <p class="text-2xl font-bold text-gray-800">2.8%</p>
            <p class="text-green-600 text-sm">stable</p>
          </div>
        </div>
      </div>

      <!-- Expert Opinion / Interview Section -->
        ...
        <div class="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
          <div>
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-red-400 font-semibold text-sm uppercase tracking-wider">CEO Interview</span>
            </div>
            <h3 class="text-2xl md:text-3xl font-bold mb-2">"Cambodia is Ready for Tech Investment Boom"</h3>
            <p class="text-gray-300 max-w-2xl">Exclusive with David Lim, CEO of Phnom Penh SEZ Plc, on FDI trends and industrial transformation.</p>
          </div>
      ...
      <!-- More Business News Load More Button -->
...
import { 
  ...
  Facebook, Twitter, Instagram, Clock, TrendingUp, BarChart3, LineChart, Briefcase
...
// Navigation items (Business active)
const navItems = ref([
...
// Business sub-tabs
const businessTabs = ['All', 'Markets', 'Banking', 'Real Estate', 'Trade', 'Startups']
const activeTab = ref('All')

// Business articles data (Cambodia focused)
const businessArticles = ref([
  {
    id: 1,
    title: "CSX Welcomes New Listing: ABC Logistics Raises $20M",
    excerpt: "The logistics firm becomes the 15th listed company on Cambodia's stock exchange.",
  ...
  {
    id: 2,
    title: "Microfinance Institutions Report Lower NPL Ratios",
    excerpt: "Improved repayment rates signal stronger household financial health.",
    image: "https://images.unsplash.com/photo-1556742031-c6961e8560b0?w=400&h=250&fit=crop",
    subcategory: "Banking",
    date: "May 27, 2025",
    views: "1.8k"
  },
  {
    id: 3,
    title: "Sihanoukville Condo Market Sees Foreign Buyer Surge",
    excerpt: "Chinese and Japanese investors return as coastal infrastructure improves.",
  ...
  {
    id: 4,
    title: "Cambodia-EU Trade Deal Enters Second Phase",
    excerpt: "Expanded quota for rice and footwear exports under Everything But Arms initiative.",
    image: "https://images.unsplash.com/photo-1524502397800-2eeaad7c3fe5?w=400&h=250&fit=crop",
    subcategory: "Trade",
    date: "May 25, 2025",
    views: "2.2k"
  },
  {
    id: 5,
    title: "Phnom Penh Tech Incubator Graduates 10 Startups",
    excerpt: "Venture capital funding for fintech and agritech ventures reaches record levels.",
  ...
  {
    id: 6,
    title: "ACLEDA Bank Expands Digital Lending Platform",
    excerpt: "Mobile loan approvals now available in rural provinces within 24 hours.",
    image: "https://images.unsplash.com/photo-1556742031-c6961e8560b0?w=400&h=250&fit=crop",
    subcategory: "Banking",
    date: "May 23, 2025",
    views: "2.6k"
...
const filteredBusinessArticles = computed(() => {
  if (activeTab.value === 'All') return businessArticles.value
  return businessArticles.value.filter(article => article.subcategory === activeTab.value)
})
