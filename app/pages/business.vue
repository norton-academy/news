...
import { useBusinessFeed, BUSINESS_SUB_TOPICS } from '~/composables/useBusinessFeed'
...
useSeoMeta({
  title: 'Business',
  description: 'Latest Cambodia business news covering markets, trade, startups, corporate policy, and investment.',
})
    ...
    <div class=" mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 xl:grid-cols-4 gap-8 items-start">
        ...
        <NewSidebar
          ...
          :sub-topics="BUSINESS_SUB_TOPICS"
