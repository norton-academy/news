...
import { useAgricultureFeed, AGRICULTURE_SUB_TOPICS } from '~/composables/useAgricultureFeed'
...
useSeoMeta({
  title: 'Agriculture',
  description: 'Latest Cambodia agriculture news covering crops, livestock, agri-tech, trade, water, and sustainability.',
})
    ...
    <div class=" mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 xl:grid-cols-4 gap-8 items-start">
        ...
        <NewSidebar
          ...
          :sub-topics="AGRICULTURE_SUB_TOPICS"
