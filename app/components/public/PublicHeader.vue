  ...
  >
    <div class="flex h-16 items-center justify-between lg:h-20">
      <NuxtLink to="/" class="flex items-center space-x-3 group cursor-pointer select-none">
        ...
        <span class="text-2xl font-black bg-gradient-to-r from-red-600 via-rose-500 to-amber-500 bg-clip-text text-transparent tracking-tight dark:from-red-500 dark:via-rose-400 dark:to-orange-400 transition-all duration-300 group-hover:brightness-110">
          COBO-NEWS
        </span>
      </NuxtLink>
      ...
      <nav class="hidden items-center overflow-x-auto scroll-smooth lg:flex">
        <div class="flex items-center gap-1 whitespace-nowrap px-1">
          <NuxtLink
            ...
            :key="item.name"
            :to="item.href"
            class="rounded-full px-3 py-2 text-sm font-medium text-zinc-700 transition-all duration-200 ease-in-out hover:bg-red-50 hover:text-red-600 active:scale-95 dark:text-zinc-300 dark:hover:bg-red-950/40 dark:hover:text-red-400"
      ...
      <div class="hidden items-center gap-2 lg:flex">
        ...
        <button
          type="button"
          class="relative inline-flex size-10 items-center justify-center rounded-xl text-zinc-600 transition-all duration-200 ease-in-out hover:bg-zinc-100 hover:text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-950/10 active:scale-95 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-white dark:focus:ring-white/10"
    ...
    >
      <div class="space-y-5">
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="text-xl font-black bg-gradient-to-r from-red-600 via-rose-500 to-amber-500 bg-clip-text text-transparent dark:from-red-500 dark:via-rose-400 dark:to-orange-400">
              COBO-NEWS
            </div>
            <div class="text-xs text-zinc-500 dark:text-zinc-400">Cambodia News</div>
          </div>
        </div>
        ...
        <nav class="space-y-1">
          <NuxtLink
            ...
            :key="item.name"
            :to="item.href"
            class="flex items-center justify-between rounded-xl px-4 py-3 text-sm font-medium text-zinc-700 transition-all duration-200 ease-in-out hover:bg-red-50 hover:text-red-600 active:translate-x-1 dark:text-zinc-300 dark:hover:bg-red-950/30 dark:hover:text-red-400"
