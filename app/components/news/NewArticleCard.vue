  ...
  >
    <div>
      <div class="relative overflow-hidden h-48 bg-slate-100 dark:bg-slate-800 shrink-0">
        ...
        />
        <span
          class="absolute top-3 left-3 inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wide px-2.5 py-1 rounded-md bg-white/90 dark:bg-slate-900/95 text-red-700 dark:text-red-400 shadow-sm border border-slate-100 dark:border-slate-800"
        >
      ...
      <div class="p-5 pb-0">
        <div class="flex items-center gap-2 mb-2.5 text-xs">
          <span class="size-1.5 rounded-full shrink-0" style="background: #ef4444"></span>
